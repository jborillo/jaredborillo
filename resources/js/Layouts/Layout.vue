<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Jared Borillo</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fmnl9-1.fna.fbcdn.net/v/t1.0-9/133477580_3999232006764056_8348236739053880866_o.jpg?_nc_cat=104&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=loppDEbJjo0AX-ehNVT&_nc_ht=scontent.fmnl9-1.fna&oh=99a532a7a3477faae720130c285e2516&oe=6083427B" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Jared Borillo</h4>
            </div>
        </div>
    </div>
      </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Jared Borillo</a>
                </div>
